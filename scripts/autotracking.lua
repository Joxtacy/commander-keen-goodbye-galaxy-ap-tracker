...
local CK4_CONE_LAYOUT = {
	[2] = {
		{lo=0, hi=0, entry="Slug Village - Ice Cream Cone 1", section="Ice Cream Cones (Pogo)"},
		{lo=1, hi=1, entry="Slug Village - Ice Cream Cone 2", section="Ice Cream Cones"},
		{lo=2, hi=2, entry="Slug Village - Ice Cream Cone 3", section="Ice Cream Cones"},
	},
	[3] = {
		{lo=0, hi=0, entry="The Perilous Pit - Ice Cream Cone 1", section="Ice Cream Cones (Pogo)"},
	},
	[4] = {
		{lo=0, hi=1, entry="Cave of the Descendents - Ice Cream Cones 1-2", section="Ice Cream Cones"},
		{lo=2, hi=3, entry="Cave of the Descendents - Ice Cream Cones 3-4", section="Ice Cream Cones"},
		{lo=4, hi=7, entry="Cave of the Descendents - Ice Cream Cones 5-8", section="Ice Cream Cones"},
		{lo=8, hi=8, entry="Cave of the Descendents - Ice Cream Cone 9", section="Ice Cream Cones"},
		{lo=9, hi=9, entry="Cave of the Descendents - Ice Cream Cone 10", section="Ice Cream Cones"},
		{lo=10, hi=10, entry="Cave of the Descendents - Ice Cream Cone 11", section="Ice Cream Cones (Pogo)"},
	},
	[5] = {
		{lo=0, hi=0, entry="Chasm of Chills - Ice Cream Cone 1", section="Ice Cream Cones"},
		{lo=1, hi=1, entry="Chasm of Chills - Ice Cream Cone 2", section="Ice Cream Cones"},
		{lo=2, hi=2, entry="Chasm of Chills - Ice Cream Cone 3", section="Ice Cream Cones (Pogo)"},
		{lo=3, hi=3, entry="Chasm of Chills - Ice Cream Cones 4, 6", section="Ice Cream Cones"},
		{lo=5, hi=5, entry="Chasm of Chills - Ice Cream Cones 4, 6", section="Ice Cream Cones"},
		{lo=4, hi=4, entry="Chasm of Chills - Ice Cream Cones 5, 7", section="Ice Cream Cones"},
		{lo=6, hi=6, entry="Chasm of Chills - Ice Cream Cones 5, 7", section="Ice Cream Cones"},
	},
	[6] = {
	...
	[8] = {
		{lo=1, hi=1, entry="Sand Yego - Ice Cream Cone 2", section="Ice Cream Cones"},
		{lo=2, hi=2, entry="Sand Yego - Ice Cream Cone 3", section="Ice Cream Cones (Pogo)"},
		{lo=3, hi=3, entry="Sand Yego - Ice Cream Cone 4", section="Ice Cream Cones"},
	},
	[9] = {
		{lo=0, hi=1, entry="Miragia - Ice Cream Cones 1-2", section="Ice Cream Cones (Pogo)"},
		{lo=2, hi=4, entry="Miragia - Ice Cream Cones 3-5", section="Ice Cream Cones"},
	},
	[11] = {
		{lo=0, hi=5, entry="Pyramid of the Moons - Ice Cream Cones 1-6", section="Ice Cream Cones (Pogo)"},
	},
	[12] = {
		{lo=0, hi=0, entry="Pyramid of Shadows - Ice Cream Cone 1", section="Ice Cream Cones"},
	},
	[13] = {
		{lo=0, hi=0, entry="Pyramid of the Gnosticine Ancients - Ice Cream Cone 1", section="Ice Cream Cones (Pogo)"},
	},
	[15] = {
		{lo=0, hi=0, entry="Isle of Tar - Ice Cream Cone 1", section="Ice Cream Cones (Pogo)"},
		{lo=1, hi=1, entry="Isle of Tar - Ice Cream Cone 2", section="Ice Cream Cones"},
		{lo=2, hi=2, entry="Isle of Tar - Ice Cream Cone 3", section="Ice Cream Cones"},
	},
	[16] = {
		{lo=0, hi=4, entry="Isle of Fire - Ice Cream Cones 1-5", section="Ice Cream Cones (Pogo)"},
	},
}
local CK5_SUGAR_LAYOUT = {
	[2] = {
		{lo=0, hi=1, entry="Security Center - Bags O' Sugar 1, 2, 5, 6", section="Bags O' Sugar (Blue Gem)"},
		{lo=4, hi=5, entry="Security Center - Bags O' Sugar 1, 2, 5, 6", section="Bags O' Sugar (Blue Gem)"},
		{lo=2, hi=3, entry="Security Center - Bags O' Sugar 3, 4, 7, 8", section="Bags O' Sugar (Blue Gem)"},
		{lo=6, hi=7, entry="Security Center - Bags O' Sugar 3, 4, 7, 8", section="Bags O' Sugar (Blue Gem)"},
		{lo=8, hi=13, entry="Security Center - Bags O' Sugar 9-14", section="Bags O' Sugar (Blue Gem)"},
		{lo=14, hi=19, entry="Security Center - Bags O' Sugar 15-20", section="Bags O' Sugar (Pogo)"},
		{lo=20, hi=23, entry="Security Center - Bags O' Sugar 21-24", section="Bags O' Sugar"},
		{lo=24, hi=27, entry="Security Center - Bags O' Sugar 25-28", section="Bags O' Sugar"},
	},
	[3] = {
		{lo=0, hi=1, entry="Defense Tunnel Vlook - Bags O' Sugar 1, 2, 4, 5", section="Bags O' Sugar"},
		{lo=3, hi=4, entry="Defense Tunnel Vlook - Bags O' Sugar 1, 2, 4, 5", section="Bags O' Sugar"},
		{lo=2, hi=2, entry="Defense Tunnel Vlook - Bags O' Sugar 3, 6, 7", section="Bags O' Sugar"},
		{lo=5, hi=6, entry="Defense Tunnel Vlook - Bags O' Sugar 3, 6, 7", section="Bags O' Sugar"},
	},
	[4] = {
		{lo=0, hi=3, entry="Energy Flow Systems - Bags O' Sugar 1-4", section="Bags O' Sugar"},
		{lo=4, hi=5, entry="Energy Flow Systems - Bags O' Sugar 5-6", section="Bags O' Sugar"},
		{lo=6, hi=9, entry="Energy Flow Systems - Bags O' Sugar 7-10", section="Bags O' Sugar"},
	},
	[5] = {
		{lo=0, hi=3, entry="Defense Tunnel Burrh - Bags O' Sugar 1-4", section="Bags O' Sugar (Red Gem, Pogo)"},
	},
	[7] = {
		{lo=0, hi=2, entry="Defense Tunnel Sorra - Bags O' Sugar 1-3", section="Bags O' Sugar"},
		{lo=3, hi=12, entry="Defense Tunnel Sorra - Bags O' Sugar 4-13", section="Bags O' Sugar"},
	},
	[8] = {
		{lo=0, hi=1, entry="Neutrino Burst Injector - Bags O' Sugar 1-2", section="Bags O' Sugar (Pogo)"},
		{lo=2, hi=3, entry="Neutrino Burst Injector - Bags O' Sugar 3-4", section="Bags O' Sugar"},
	},
	[9] = {
		{lo=0, hi=1, entry="Defense Tunnel Teln - Bags O' Sugar 1-2", section="Bags O' Sugar (Yellow Gem, Blue Gem)"},
		{lo=2, hi=5, entry="Defense Tunnel Teln - Bags O' Sugar 3-6", section="Bags O' Sugar (Yellow Gem, Blue Gem)"},
		{lo=6, hi=9, entry="Defense Tunnel Teln - Bags O' Sugar 7-10", section="Bags O' Sugar (Yellow Gem)"},
	},
	[10] = {
		{lo=0, hi=3, entry="Brownian Motion Inducer - Bags O' Sugar 1-4", section="Bags O' Sugar"},
		{lo=4, hi=7, entry="Brownian Motion Inducer - Bags O' Sugar 5-8", section="Bags O' Sugar (Pogo)"},
	},
	[11] = {
		{lo=0, hi=5, entry="Gravitational Damping Hub - Bags O' Sugar 1-6", section="Bags O' Sugar (Green Gem, Pogo)"},
		{lo=6, hi=9, entry="Gravitational Damping Hub - Bags O' Sugar 7-10", section="Bags O' Sugar (Green Gem, Pogo)"},
		{lo=10, hi=12, entry="Gravitational Damping Hub - Bags O' Sugar 11-13", section="Bags O' Sugar (Pogo)"},
		{lo=13, hi=14, entry="Gravitational Damping Hub - Bags O' Sugar 14-15", section="Bags O' Sugar"},
	},
	[12] = {
		{lo=0, hi=5, entry="Quantum Explosion Dynamo - Bags O' Sugar 1-6", section="Bags O' Sugar (Red Gem, Yellow Gem, Blue Gem, Green Gem, Pogo)"},
		{lo=6, hi=8, entry="Quantum Explosion Dynamo - Bags O' Sugar 7-9", section="Bags O' Sugar (Pogo)"},
	},
}
CONE_IDS = {}
SUGAR_IDS = {}
