...
local CK4_CONE_LAYOUT = {
	[2] = {
		{lo=0, hi=0, entry="Slug Village - Ice Cream Cones (Pogo)", section="Ice Cream Cones (Pogo)"},
		{lo=1, hi=2, entry="Slug Village - Ice Cream Cones", section="Ice Cream Cones"},
	},
	[3] = {
		{lo=0, hi=0, entry="The Perilous Pit - Ice Cream Cones (Pogo)", section="Ice Cream Cones (Pogo)"},
	},
	[4] = {
		{lo=0, hi=9, entry="Cave of the Descendents - Ice Cream Cones", section="Ice Cream Cones"},
		{lo=10, hi=10, entry="Cave of the Descendents - Ice Cream Cones (Pogo)", section="Ice Cream Cones (Pogo)"},
	},
	[5] = {
		{lo=0, hi=1, entry="Chasm of Chills - Ice Cream Cones", section="Ice Cream Cones"},
		{lo=3, hi=6, entry="Chasm of Chills - Ice Cream Cones", section="Ice Cream Cones"},
		{lo=2, hi=2, entry="Chasm of Chills - Ice Cream Cones (Pogo)", section="Ice Cream Cones (Pogo)"},
	},
	[6] = {
		{lo=0, hi=1, entry="Crystalus - Ice Cream Cones (Pogo)", section="Ice Cream Cones (Pogo)"},
		{lo=2, hi=2, entry="Crystalus - Ice Cream Cones (Blue Gem)", section="Ice Cream Cones (Blue Gem)"},
	},
	[7] = {
		{lo=0, hi=0, entry="Hilville - Ice Cream Cones (Pogo)", section="Ice Cream Cones (Pogo)"},
	},
	[8] = {
		{lo=1, hi=1, entry="Sand Yego - Ice Cream Cones", section="Ice Cream Cones"},
		{lo=3, hi=3, entry="Sand Yego - Ice Cream Cones", section="Ice Cream Cones"},
		{lo=2, hi=2, entry="Sand Yego - Ice Cream Cones (Pogo)", section="Ice Cream Cones (Pogo)"},
	},
	[9] = {
		{lo=0, hi=1, entry="Miragia - Ice Cream Cones (Pogo)", section="Ice Cream Cones (Pogo)"},
		{lo=2, hi=4, entry="Miragia - Ice Cream Cones", section="Ice Cream Cones"},
	},
	[11] = {
		{lo=0, hi=5, entry="Pyramid of the Moons - Ice Cream Cones (Pogo)", section="Ice Cream Cones (Pogo)"},
	},
	[12] = {
		{lo=0, hi=0, entry="Pyramid of Shadows - Ice Cream Cones", section="Ice Cream Cones"},
	},
	[13] = {
		{lo=0, hi=0, entry="Pyramid of the Gnosticine Ancients - Ice Cream Cones (Pogo)", section="Ice Cream Cones (Pogo)"},
	},
	[15] = {
		{lo=0, hi=0, entry="Isle of Tar - Ice Cream Cones (Pogo)", section="Ice Cream Cones (Pogo)"},
		{lo=1, hi=2, entry="Isle of Tar - Ice Cream Cones", section="Ice Cream Cones"},
	},
	[16] = {
		{lo=0, hi=4, entry="Isle of Fire - Ice Cream Cones (Pogo)", section="Ice Cream Cones (Pogo)"},
	},
}
local CK5_SUGAR_LAYOUT = {
	...
	[3] = {
		{lo=0, hi=6, entry="Defense Tunnel Vlook - Bags O' Sugar", section="Bags O' Sugar"},
	},
	[4] = {
		{lo=0, hi=9, entry="Energy Flow Systems - Bags O' Sugar", section="Bags O' Sugar"},
	},
	[5] = {
		{lo=0, hi=3, entry="Defense Tunnel Burrh - Bags O' Sugar (Red Gem, Pogo)", section="Bags O' Sugar (Red Gem, Pogo)"},
	},
	[7] = {
		{lo=0, hi=12, entry="Defense Tunnel Sorra - Bags O' Sugar", section="Bags O' Sugar"},
	},
	[8] = {
		{lo=0, hi=1, entry="Neutrino Burst Injector - Bags O' Sugar (Pogo)", section="Bags O' Sugar (Pogo)"},
		{lo=2, hi=3, entry="Neutrino Burst Injector - Bags O' Sugar", section="Bags O' Sugar"},
	},
	[9] = {
		{lo=0, hi=5, entry="Defense Tunnel Teln - Bags O' Sugar (Yellow Gem, Blue Gem)", section="Bags O' Sugar (Yellow Gem, Blue Gem)"},
		{lo=6, hi=9, entry="Defense Tunnel Teln - Bags O' Sugar (Yellow Gem)", section="Bags O' Sugar (Yellow Gem)"},
	},
	[10] = {
	...
	[11] = {
		...
		{lo=10, hi=12, entry="Gravitational Damping Hub - Bags O' Sugar (Pogo)", section="Bags O' Sugar (Pogo)"},
		{lo=13, hi=14, entry="Gravitational Damping Hub - Bags O' Sugar", section="Bags O' Sugar"},
	},
	[12] = {
		{lo=0, hi=5, entry="Quantum Explosion Dynamo - Bags O' Sugar (Red Gem, Yellow Gem, Blue Gem, Green Gem, Pogo)", section="Bags O' Sugar (Red Gem, Yellow Gem, Blue Gem, Green Gem, Pogo)"},
		{lo=6, hi=8, entry="Quantum Explosion Dynamo - Bags O' Sugar (Pogo)", section="Bags O' Sugar (Pogo)"},
	},
}
CONE_IDS = {}
SUGAR_IDS = {}
